...
public class ActivityOurMission extends AppCompatActivity {
    ...
    public void setupToolbar() {
        ...
        if (actionBar != null) {
            ...
            getSupportActionBar().setTitle(R.string.title_our_mission);
        }
    }
    ...
    public void loadData() {
        ...
        Call<Settings> call = apiInterface.getOurMission();
        call.enqueue(new Callback<Settings>() {
            @Override
            public void onResponse(Call<Settings> call, Response<Settings> response) {
                String our_mission = response.body().getOurMission();
                try {
