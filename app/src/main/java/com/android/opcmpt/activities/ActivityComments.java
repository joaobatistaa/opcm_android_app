...
import com.android.opcmpt.adapter.AdapterComments;
import com.android.opcmpt.callbacks.CallbackComments;
import com.android.opcmpt.models.Comments;
                ...
                if (myApplication.getIsLogin() && myApplication.getUserId().equals(obj.user_id)) {
                    ...
                    btn_edit.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View view) {
                            ...
                            i.putExtra("comment_id", obj.comment_id);
                                ...
                                public void onClick(DialogInterface dialog, int which) {
                                    ...
                                    call.enqueue(new Callback<Value>() {
                                        ...
                                        public void onFailure(Call<Value> call, Throwable t) {
                                            t.printStackTrace();
                                            Toast.makeText(ActivityComments.this, "Erro de conexão à internet!", Toast.LENGTH_SHORT).show();
                                        }
                                    });
                                }
                            });
                    ...
                    btn_reply.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View view) {
                            ...
                            intent.putExtra("user_name", obj.display_name);
