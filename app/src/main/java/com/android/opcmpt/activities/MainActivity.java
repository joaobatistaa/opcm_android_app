...
import com.android.opcmpt.fragment.FragmentEvents;
import com.android.opcmpt.fragment.FragmentFavorite;
import com.android.opcmpt.fragment.FragmentProfile;
import com.android.opcmpt.fragment.FragmentRecent;
import com.android.opcmpt.fragment.FragmentVideo;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final long verifica = intent.getLongExtra("verifica", 0);
            ...
            if (imageUrl.endsWith(".jpg") || imageUrl.endsWith(".jpeg") || imageUrl.endsWith(".png") || imageUrl.endsWith(".gif")) {
                ...
                alert.setPositiveButton(R.string.dialog_read_more, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        if (verifica == 2) {
                            Intent intent = new Intent(getApplicationContext(), ActivityNotificationDetailEvents.class);
